...
class AccountResource(ModelResource):
    ...
    def override_urls(self):
        return [
                url(r"^(?P<resource_name>%s)%s$" % (self._meta.resource_name, trailing_slash()), self.wrap_view('dispatch_detail'), name="api_account_detail"),
            ]
    ...
    def dispatch_detail(self, request, **kwargs):
        ...
        return super(AccountResource, self).dispatch_detail(request, **kwargs)
    ...
    def put_detail(self, request, **kwargs):
        ...
        return super(AccountResource, self).put_detail(request, **kwargs)
    ...
    def obj_update(self, bundle, request, **kwargs):
        ...
        return super(AccountResource, self).obj_update(bundle, request, **kwargs)
